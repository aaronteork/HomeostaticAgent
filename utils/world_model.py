...
class GaussianActorNetwork(nn.Module):
    """Gaussian Actor network for policy in latent space."""
...
class BetaActorNetwork(nn.Module):
    """BetaActor network for policy in latent space."""
